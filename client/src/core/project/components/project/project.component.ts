...
export class ProjectComponent implements OnInit {
    ...
    public save(): void {
        ...
        ? projectActions.requestEditProject({id: this.project._id, name: this.playNameValue?.value, heroImage: this.playImageValue?.value})
        : projectActions.requestAddProject({name: this.playNameValue?.value, heroImage: this.playImageValue?.value});
